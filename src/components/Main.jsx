  ...
  return (
    <div className="bg-black z-10 opacity-95 pr-8">
      ...
      <div className="w-screen h-screen flex justify-center items-center flex-col">
        <h2 className="text-white border border-white border-solid text-[1vw] rounded-full p-5 mb-8">
          Marvel <br /> Hero <br /> Test
        </h2>
        <h1 className="text-white z-100 text-[3.5vw] font-bold">마블 히어로 테스트</h1>
        <div className="w-1/6 h-px bg-white mt-12 mb-12"></div>
        <p className="text-white text-center text-[1vw] pl-8 pr-8 leading-7">
        ...
        <button
          ...
          className="bg-white opacity-50 pl-[4vw] pr-[4vw] pt-[2vw] pb-[2vw] rounded-[1vw] mt-12 text-[1vw]"
        >
          테스트 시작하기
        </button>
      </div>
